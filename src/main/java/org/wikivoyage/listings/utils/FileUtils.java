...
public class FileUtils {
     ...
     */
    public static void createDirectory(Path directoryName) throws FileUtilsException {
        File file = directoryName.toFile();
        if (file.isDirectory()) {
            return;
        }
        boolean result = directoryName.toFile().mkdirs();
        if (!result) {
